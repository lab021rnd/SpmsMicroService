...
{
    public static class GfsFtpDownloadTimer
    {
        ...
        [FunctionName("GfsFtpDownloadTimer")]
        ...
        //6시간 현재는 갱신하고 forecast는 00시 갱신
        private static void CheckToGetGfsFile()
        {
            ...
            for (int i = 0; i < _dayToCheckForDownload + 1; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    ...
                    var tempfolderName = "gfs." + tempyyyyMMdd + hour;
                    var tempFileName = "gfs.t" + hour + "z.pgrb2.0p50.f000";
                    var filePath = "/pub/data/nccf/com/gfs/prod/" + tempfolderName + "/" + tempFileName;
                    ...
                    tempyyyyMMddhhmm = checkData.AddDays(i);
                    tempFileName = "gfs.t" + hour + "z.pgrb2.0p50.f003";
                    filePath = "/pub/data/nccf/com/gfs/prod/" + tempfolderName + "/" + tempFileName;
